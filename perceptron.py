...
# SPECIFICATION: Contrast the performance of algorithms and assess which pairing of two hyperparameters
# (learning rate and shuffle) yields the optimal predictive performance for each classifier
